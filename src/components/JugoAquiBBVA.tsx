          ...
          {!done ? (
            ...
            <div className="rounded-xl p-4" style={{ background: won ? "#f0faf2" : "#fff5f5", border: `1px solid ${won ? "rgba(30,107,46,0.22)" : "rgba(184,28,20,0.18)"}` }}>
              ...
              <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-2">
                <a href="/album" className="text-center font-oswald font-semibold uppercase tracking-wider text-[11px] py-3 rounded-xl" style={{ background: "#f0faf2", color: "#1e6b2e", border: "1px solid rgba(30,107,46,0.18)" }}>Ver álbum BBVA</a>
